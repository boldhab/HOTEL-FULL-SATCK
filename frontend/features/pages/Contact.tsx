...
const mapEmbedQuery = encodeURIComponent("Ethio Bernos Hotel, Debre Berhan, Ethiopia");
const mapEmbedUrl = `https://www.google.com/maps?q=${mapEmbedQuery}&z=17&output=embed`;
